...
function some(e){
	console.log(tau.getTop());
	console.log(tau.getSide());
}

function plus(e){
	dpi = tools.roundPlus(dpi + 0.05, 2);
	tau.change({ size: {dpi: dpi, scale: dpi} });
	document.getElementById('scale').innerHTML = dpi;
