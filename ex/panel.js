...
var dataSet = JSON.parse('[{"text":"Wave", "select": "true","text2":"","type":"4","exp":"WAVE","children":[{"text":"Mayu002717","text2":"","type":"5","exp":"1","nopercent":1},{"text":"Julu002717","text2":"","type":"5","exp":"2","nopercent":1}]}]');
...
function new_function(){
	...
	panelPanel = new dash_ui({
		parent: document.getElementsByClassName('first')[1],
		functions: {
			rightClick: function(link, item){
				if(item){
					item.zindex++; 
					panelPanel.change();
					return true;
